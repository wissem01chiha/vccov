...
find_path(CTemplate_INCLUDE_DIR ctemplate/template_annotator.h
          HINTS ${CMAKE_PREFIX_PATH} ${CMAKE_SYSTEM_PREFIX_PATH}
          PATHS ${CMAKE_SYSTEM_INCLUDE_PATH} ${CMAKE_INCLUDE_PATH} ${CMAKE_BINARY_DIR} ${CMAKE_SOURCE_DIR}
                /usr/include
                /usr/local/include
)
...
if(CTemplate_VARNAMES)
  ...
  set(CTemplate_RUN_OUTPUT "")
  set(CTemplate_RUN_RESULT 1)
endif()

string(REGEX MATCH "[0-9]+\\.[0-9]+\\.[0-9]+" CTemplate_VERSION_STRING "${CTemplate_RUN_OUTPUT}")
if(NOT CTemplate_VERSION_STRING)
  set(CTemplate_VERSION_STRING "")
endif()
