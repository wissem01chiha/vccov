...
{
    //-------------------------------------------------------------------------
    const std::vector<wchar_t> Wildcards::EscapedChars = { L'\\', L'^', L'$', L'.', L'+',
                                                           L'(',  L')', L'[', L']', L'{',
                                                           L'}',  L'|', L'?' };

    //-------------------------------------------------------------------------
    Wildcards::Wildcards(std::wstring str, bool isRegexCaseSensitiv) : originalStr_(str)
    {
    ...
    //-------------------------------------------------------------------------
    Wildcards::Wildcards(Wildcards&& wildcards) : wildcars_(std::move(wildcards.wildcars_))
    {
    }
