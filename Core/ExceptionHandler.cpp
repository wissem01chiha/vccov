...
namespace CppCoverage
{
    ...
    void ExceptionHandler::InitExceptionCode()
    {
        ...
        exceptionCode_.emplace(EXCEPTION_NONCONTINUABLE_EXCEPTION,
    ...
    ExceptionHandlerStatus ExceptionHandler::HandleException(
        HANDLE hProcess, const EXCEPTION_DEBUG_INFO& exceptionDebugInfo, std::wostream& message)
    {
        ...
        if (exceptionDebugInfo.dwFirstChance)
        {
            ...
            if (it != breakPointExceptionCode_.end())
            {
                ...
                if (std::find(processHandles.begin(), processHandles.end(), hProcess) ==
                    processHandles.end())
        ...
        return (exceptionCode == CppExceptionErrorCode) ? ExceptionHandlerStatus::CppError
                                                        : ExceptionHandlerStatus::Error;
    }
    ...
    std::wstring ExceptionHandler::GetExceptionStrFromCode(DWORD exceptionCode) const
    {
        ...
        FormatMessage(FORMAT_MESSAGE_ALLOCATE_BUFFER | FORMAT_MESSAGE_FROM_SYSTEM |
                      ...
                      ntDllModule, exceptionCode, MAKELANGID(LANG_ENGLISH, SUBLANG_ENGLISH_US),
