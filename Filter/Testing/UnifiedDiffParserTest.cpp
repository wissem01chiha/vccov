...
#include "Filter/UnifiedDiffParser.hpp"
#include "Filter/UnifiedDiffParserException.hpp"
...
namespace FileFilterTest
{
    ...
    {
        //-------------------------------------------------------------------------
        const File& GetFile(const std::vector<File>& files, const fs::path& path)
        {
        ...
        //-------------------------------------------------------------------------
        int GetSelectedLinesCount(const std::vector<File>& files, const fs::path& path)
        {
        ...
        //-------------------------------------------------------------------------
        void AssertSingleFile(const std::vector<File>& files, const std::wstring& filename,
    ...
    TEST_F(UnifiedDiffParserTest, ExpectedFiles)
    {
        ...
        ASSERT_EQ(4,
                  GetSelectedLinesCount(files, "CppCoverageTest/ExecutedAddressManagerTest.cpp"));
    ...
    TEST_F(UnifiedDiffParserTest, ExpectedUpdatedLines)
    {
        ...
        const std::set<int> expectedLines = { 93,  95,  105, 130, 132, 133, 134,
    ...
    {
        ASSERT_EQ(UnifiedDiffParserException::ErrorNoFilenameBeforeHunks, GetError(L"@@"));
    }
    ...
    {
        std::wistringstream istr{ L"--- test1.txt\n"
                                  L"+++ test2.txt\n"
                                  L"@@ -0,0 +1 @@\n"
                                  L"+ test\n"
                                  L"\\ No newline at end of file\n" };
    ...
    {
        std::wistringstream istr{ L"--- test2.txt\n"
                                  L"+++ test1.txt\n"
                                  L"@@ -1 +0,0 @@\n"
                                  L"- test\n"
                                  L"\\ No newline at end of file\n" };
