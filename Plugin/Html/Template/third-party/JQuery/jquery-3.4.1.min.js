...
!function(e, t) {
    ...
    var t = [], E = C.document, r = Object.getPrototypeOf, s = t.slice, g = t.concat, u = t.push,
        i = t.indexOf, n = {}, o = n.toString, v = n.hasOwnProperty, a = v.toString,
    ...
    var h = function(n) {
        var e, d, b, o, i, h, f, g, w, u, l, T, C, a, E, v, s, c, y,
            k = "sizzle" + 1 * new Date, m = n.document, S = 0, r = 0, p = ue(), x = ue(), N = ue(),
            A = ue(),
            D =
                function(e, t) {
                return e === t && (l = !0), 0
            ...
            X = new RegExp($), V = new RegExp("^" + I + "$"), G = {
                ...
                bool : new RegExp("^(?:" + R + ")$", "i"),
                needsContext :
                    new RegExp("^" + M + "*[>+~]|:(even|odd|eq|gt|lt|nth|first|last)(?:\\(" + M +
                                   "*((?:-\\d)?\\d*)" + M + "*\\)|)(?=[^-]|$)",
                               "i")
            },
                             ...
                             return s[k] ? le(function(e, t, n, r) {
                                 ...
                                 while (a--)
                                     (i = o[a]) && (e[a] = !(t[a] = i))
                                         ...
                                         : function(e, t, n) {
                                               return r[0] = e, s(r, null, n, i), r[0] = null,
                                                      !i.pop()
                                           }
                         }),
                         has : le(function(t) {
        ...
        {
            for (var i, t, n,
                 r = e.length, o = b.relative[e[0].type], a = o || b.relative[" "], s = o ? 1 : 0,
                 u = be(
                     function(e) {
                         return e === i
                     },
               ...
               h = se.tokenize =
                   ...
                   while (a)
                   {
                       for (o in n && !(r = _.exec(a)) ||
                            ...
                            n = !1,
                            (r = z.exec(a)) &&
                                (n = r.shift(), i.push({ value : n, type : r[0].replace(B, " ") }),
                                a  = a.slice(n.length)),
                            b.filter)
    ...
    k.uniqueSort = k.unique = h.uniqueSort, k.text = h.getText, k.isXMLDoc = h.isXML,
            ...
            queue : function(e, t, n) {
                ...
                if (e)
                    return t = (t || "fx") + "queue", r = Q.get(e, t),
                           n && (!r || Array.isArray(n) ? r = Q.access(e, t, k.makeArray(n))
                                                        : r.push(n)),
                           r || []
            },
                          ...
                          (l[c] = (u = a = o = void 0, a = (i = r).ownerDocument, s = i.nodeName,
                                   (u = ce[s]) ||
                                       (o = a.body.appendChild(a.createElement(s)),
                                        u = k.css(o, "display"), o.parentNode.removeChild(o),
               ...
               k.event.special[e] = {
                   ...
                   handle : function(e) {
                       ...
                       return n && (n === this || k.contains(this, n)) ||
                                  (e.type = r.origType, t = r.handler.apply(this, arguments),
                                   e.type = i),
                              t
                   }
               }
    ...
    function Ie(n, r, i, o)
    {
                  ...
                  1 === e.childNodes.length && (e = t), t || o))
        {
            for (s = (a = k.map(ve(e, "script"), Pe)).length; c < f; c++)
                u = e, c !== p && (u = k.clone(u, !0, !0), s && k.merge(a, ve(u, "script"))),
                i.call(n[c], u, c);
            if (s)
    ...
    !function() {
        ...
        u.style &&
            (u.style.backgroundClip = "content-box", u.cloneNode(!0).style.backgroundClip = "",
    ...
    function et(e, t, n, r, i, o)
    {
        ...
        return !r && 0 <= o &&
                   (u += Math.max(0, Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - o -
                                               u - s - .5)) ||
                         0),
               u
    }
                       ...
                       set : function(e, t, n) {
                           ...
                           return a && o &&
                                      (s -= Math.ceil(
                                           ...
                                           parseFloat(i[u]) - et(e, u, "border", !1, i) - .5)),
        ...
        ((k.Tween = nt).prototype = {
            ...
            run : function(e) {
                ...
                return this.options.duration
                           ? this.pos = t = k.easing[this.easing](e, this.options.duration * e, 0,
    ...
    function dt(o, e, t)
    {
                ...
                s.promise(
                    {
                        ...
                        createTween : function(e, t) {
                            var n =
                                k.Tween(o, l.opts, e, t, l.opts.specialEasing[e] || l.opts.easing);
        ...
        for (!function(e, t) {
                 var n, r, i, o, a;
                 for (n in e)
                     if (i = t[r = V(n)], o = e[n], Array.isArray(o) && (i = o[1], o = e[n] = o[0]),
    ...
    at = E.createElement("select").appendChild(E.createElement("option")), ot.type = "checkbox",
    y.checkOn = "" !== ot.value, y.optSelected = at.selected,
            ...
            if (o = f = a = n = n || E,
                3 !== n.nodeType && 8 !== n.nodeType && !Tt.test(d + k.event.triggered) &&
                    (-1 < d.indexOf(".") && (d = (h = d.split(".")).shift(), h.sort()),
                     ...
                     t = null == t ? [ e ] : k.makeArray(t, [ e ]), c = k.event.special[d] || {},
    ...
    Ft.href = Et.href, k.extend({
        ...
        ajax : function(e, t) {
            ...
            for (i in (g = k.event && v.global) && 0 == k.active++ && k.event.trigger("ajaxStart"),
                 ...
                 f = v.url.replace(Ht, ""),
                 v.hasContent ? v.data && v.processData &&
                                    0 === (v.contentType ||
            ...
            function l(e, t, n, r)
            {
                ...
                h || (h = !0, d && C.clearTimeout(d), c = void 0, p = r || "",
                      ...
                      i ? (v.ifModified && ((u = T.getResponseHeader("Last-Modified")) &&
                                                (k.lastModified[f] = u),
                       ...
                       k.fn[o] = function(e, t) {
                           ...
                           return _(this, function(e, t, n) {
                               ...
                               return x(e) ? 0 === o.indexOf("outer")
                                      ...
                                      : 9 === e.nodeType
                                          ? (r = e.documentElement,
                                             Math.max(e.body["scroll" + a], r["scroll" + a],
