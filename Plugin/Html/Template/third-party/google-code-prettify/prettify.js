    ...
    (function() {
        function S(a)
        {
            function d(e)
            {
                ...
                var a = e.charAt(1);
                return (b = r[a])               ? b
                       : "0" <= a && a <= "7"   ? parseInt(e.substring(1), 8)
                       : a === "u" || a === "x" ? parseInt(e.substring(2), 16)
                                                : e.charCodeAt(1)
            }
            function g(e)
            {
            ...
            for (var r = { b : 8, t : 9, n : 10, v : 11, f : 12, r : 13 }, n = [], k = 0,
                     c = a.length;
                 k < c; ++k)
            {
                i = a[k];
            ...
            function g(a)
            {
                ...
                if (c == 1)
                {
                    ...
                    c.length && (c = d ? c.replace(/\r\n?/g, "\n") : c.replace(/[\t\n\r ]+/g, " "),
                                 s[j] = c, m[j << 1] = x, x += c.length, m[j++ << 1 | 1] = a)
            }
        ...
        function U(a)
        {
            for (var d = void 0, g = a.firstChild; g; g = g.nextSibling)
                var b = g.nodeType, d = b === 1   ? d ? a : g
                                        : b === 3 ? V.test(g.nodeValue) ? a : d
                                                  : d;
            return d === a ? void 0 : d
        }
        function C(a, d)
        {
            function g(a)
            {
                for (var j = a.e, k = [ j, "pln" ], c = 0, i = a.a.match(s) || [], r = {}, n = 0,
                         e = i.length;
                     n < e; ++n)
                {
                    ...
                    else
                    {
                        ...
                        if ((f = w.length >= 5 && "lang-" === w.substring(0, 5)) &&
                            !(t && typeof t[1] === "string"))
                            f = !1, w = "src";
                        f || (r[z] = w)
                    }
        ...
        function J(a, d, g)
        {
            ...
            for (var d = Math.max(0, d - 1 | 0) || 0, i = 0, n = c.length; i < n; ++i)
                k = c[i], k.className = "L" + (i + d) % 10,
                k.firstChild || k.appendChild(j.createTextNode("\u00a0")), r.appendChild(k);
            a.appendChild(r)
        }
        function p(a, d)
        {
        ...
        function K(a)
        {
            ...
            try
            {
                ...
                var s = /\bMSIE\s(\d+)/.exec(navigator.userAgent), s = s && +s[1] <= 8, d = /\n/g,
                    x = a.a, m = x.length, g = 0, j = a.d, k = j.length, b = 0, c = a.g,
                    i = c.length, r = 0;
                c[i] = m;
                var n, e;
                for (e = n = 0; e < i;)
                ...
                try
                {
                    for (; b < k;)
                    {
                        var l = j[b + 2] || m, B = c[r + 2] || m, t = Math.min(l, B), A = j[b + 1],
                            G;
        ...
        var Y = D.PR = {
            ...
            prettyPrint : D.prettyPrint =
                function(a, d) {
                            ...
                            if ((j !== h || e.test(k)) && !v.test(k))
                            {
                                ...
                                if (!m)
                                {
                                    ...
                                    if (w.test(d.tagName))
                                        ...
                                        var o = d.currentStyle, u = s.defaultView,
                                            o = (o = o ? o.whiteSpace
                                                     : u && u.getComputedStyle
                                                         ? u.getComputedStyle(d, q)
                    ...
                    for (var b = d || document.body, s = b.ownerDocument || document,
                             b =
                                 [
                    ...
                    var i = 0, r, n = /\blang(?:uage)?-([\w.]+)(?!\S)/, e = /\bprettyprint\b/,
                        v = /\bprettyprinted\b/, w = /pre|xmp/i, t = /^code$/i,
                        f = /^(?:pre|code|xmp)$/i, h = {};
                    g()
                }
        };
