...
namespace CppCoverage
{
    ...
    //-------------------------------------------------------------------------
    Options::Options(const Patterns& modulePatterns, const Patterns& sourcePatterns,
                     const StartInfo* startInfo)
        : modules_{ modulePatterns }, sources_{ sourcePatterns }, logLevel_{ LogLevel::Normal },
          isPluginModeEnabled_{ false }, isCoverChildrenModeEnabled_{ false },
          isAggregateByFileModeEnabled_{ true }, isContinueAfterCppExceptionModeEnabled_{ false },
    ...
    std::wostream& operator<<(std::wostream& ostr, const Options& options)
    {
        ...
        ostr << L"Continue after C++ exception: " << options.isContinueAfterCppExceptionModeEnabled_
             << std::endl;
        ostr << L"Optimized build support: " << options.isOptimizedBuildSupportEnabled_
             << std::endl;
