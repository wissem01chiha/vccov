...
namespace CppCoverageTest
{
    namespace
    {
        ...
        {
            explicit DebugEventsHandler(TestTools::T_HandlesFct action) : action_(action)
            {
            }
    ...
    namespace TestTools
    {
        ...
        //---------------------------------------------------------------------
        boost::optional<cov::Options> Parse(const cov::OptionsParser&       parser,
        ...
        {
            return TestCoverageConsole::GetOutputBinaryPath().string();
        }

        //---------------------------------------------------------------------
        CoverageArgs::CoverageArgs(const std::vector<std::wstring>& arguments,
                                   const std::wstring&              modulePattern,
                                   const std::wstring&              sourcePattern)
            : programToRun_{ TestCoverageConsole::GetOutputBinaryPath() }, arguments_{ arguments },
              modulePatternCollection_{ modulePattern }, sourcePatternCollection_{ sourcePattern }
        {
        }

        //---------------------------------------------------------------------
        Plugin::CoverageData ComputeCoverageData(const std::vector<std::wstring>& arguments,
                                                 const std::wstring&              modulePattern,
                                                 const std::wstring&              sourcePattern)
        {
        ...
        {
            cov::CodeCoverageRunner codeCoverageRunner{ std::make_shared<Tools::WarningManager>() };
            ...
            cov::RunCoverageSettings settings(
                startInfo, coverageFilterSettings, args.unifiedDiffSettingsCollection_,
                args.excludedLineRegexes_, args.substitutePdbSourcePath_);
