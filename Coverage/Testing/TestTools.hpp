...
namespace CppCoverageTest
{
    namespace TestTools
    {
        ...
        boost::optional<CppCoverage::Options>
        Parse(const CppCoverage::OptionsParser& parser, const std::vector<std::string>& arguments,
              bool appendProgramToRun = true, std::wostream* emptyOptionsExplanation = nullptr);
        ...
        struct CoverageArgs
        {
            CoverageArgs(const std::vector<std::wstring>& arguments,
                         const std::wstring& modulePattern, const std::wstring& sourcePattern);
