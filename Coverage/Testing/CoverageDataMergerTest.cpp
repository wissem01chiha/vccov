...
namespace CppCoverageTest
{
    namespace
    {
            ...
            const std::initializer_list<std::pair<std::wstring, int>>& coverageDataArguments)
        {
            ...
            for (const auto& args : coverageDataArguments)
                coverageDataCollection.emplace_back(
                    Plugin::CoverageData{ args.first, args.second });
        ...
        //-------------------------------------------------------------------------
        void
        AddLinesToFileCoverage(Plugin::FileCoverage&                              fileCoverage,
        ...
        //-------------------------------------------------------------------------
        void AddLine(Plugin::CoverageData& coverageData, const fs::path& modulePath,
        ...
        //-------------------------------------------------------------------------
        void CheckLineHasBeenExecuted(const std::unique_ptr<Plugin::FileCoverage>& file,
                                      int lineNumber, bool exectedValue)
        {
    ...
    TEST(CoverageDataMergerTest, Line)
    {
        ...
        AddLine(coverageDatas[0], modulePath, filePath,
