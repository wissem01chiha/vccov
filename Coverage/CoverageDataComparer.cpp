...
namespace TestHelper
{
    ...
    {
        //---------------------------------------------------------------------
        template <typename T> void AssertEqual(T&& v1, T&& v2)
        {
            EXPECT_EQ(v1, v2);
            if (v1 != v2)
        ...
        //---------------------------------------------------------------------
        void AssertLinesEquals(const Plugin::LineCoverage& line1, const Plugin::LineCoverage& line2)
        {
        ...
        //---------------------------------------------------------------------
        void AssertFilesEquals(const Plugin::FileCoverage& file1, const Plugin::FileCoverage& file2)
        {
        ...
        //---------------------------------------------------------------------
        void AssertModulesEquals(const Plugin::ModuleCoverage& module1,
                                 const Plugin::ModuleCoverage& module2)
        {
            AssertEqual(module1.GetPath(), module2.GetPath());
            AssertContainerUniquePtrEqual(module1.GetFiles(), module2.GetFiles(),
                                          AssertFilesEquals);
        }
    } // namespace

    //-------------------------------------------------------------------------
    void CoverageDataComparer::AssertEquals(const Plugin::CoverageData& coverageData,
                                            const Plugin::CoverageData& coverageDataRestored) const
    {
        ...
        AssertContainerUniquePtrEqual(coverageData.GetModules(), coverageDataRestored.GetModules(),
                                      AssertModulesEquals);
    }

    //---------------------------------------------------------------------
    void CoverageDataComparer::AssertEquals(const Plugin::ModuleCoverage* module1,
    ...
    //---------------------------------------------------------------------
    bool CoverageDataComparer::IsFirstModuleContainsSecond(const ModuleCoveragePtr& module1,
        ...
        const ModuleCoverageCollection& container2) const
    {
        return IsFirstContainsSecond<std::filesystem::path>(
            ...
            [=](const ModuleCoveragePtr& module1, const ModuleCoveragePtr& module2)
